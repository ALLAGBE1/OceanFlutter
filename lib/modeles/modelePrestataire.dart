...
class _ModelePrestataireState extends State<ModelePrestataire> {
  ...
  Future<List<Commentaire>> fetchData1() async {
    ...
    request.body = json.encode({"comment": username, "author": UserData.id, "prestataire": widget.id});
  ...
  Future<List<Rating>> postRating() async {
    ...
    request.body = json.encode({"rating": username, "author": UserData.id, "prestataire": widget.id});
    request.headers.addAll(headers);
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
              ...
              image: const DecorationImage(
                  image: AssetImage('img/background.jpg'), fit: BoxFit.cover) // Changed Image.asset to AssetImage
              ),
          child: Column(
            children: [
              const Padding(
                          ...
                          Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                Text(
                                  UserData.disponible == true ? "Oui" : "Non",
        ...
        child: FutureBuilder<List<Commentaire>>(
          ...
          builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.waiting) {
              ...
              return const Center(
                  child: Text(
                      "Il n'y a pas encore de commentaire. Soyez le premier à laisser un commentaire sur ce prestataire."));
            } else {
